...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.attendance.vacation.quota.init
    /// </summary>
    public class OapiAttendanceVacationQuotaInitRequest : BaseDingTalkRequest<OapiAttendanceVacationQuotaInitResponse>
    {
        /// <summary>
        /// 待初始化的假期余额记录
        /// </summary>
