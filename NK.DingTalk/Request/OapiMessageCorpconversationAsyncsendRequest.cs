...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.message.corpconversation.asyncsend
    /// </summary>
    public class OapiMessageCorpconversationAsyncsendRequest : BaseDingTalkRequest<OapiMessageCorpconversationAsyncsendResponse>
    {
        /// <summary>
        /// 微应用的id
        /// </summary>
